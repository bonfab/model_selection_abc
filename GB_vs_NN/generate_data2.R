...
generate_prob <- function(K, number_locus = sample(20000 -5000, 1) + 5000, number_admixed = 0, pop_sizes = rdirichlet(1, rep(1, K + number_admixed)), sample_size = sample(800 - 300, 1) + 300){
