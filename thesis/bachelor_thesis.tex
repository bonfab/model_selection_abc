...
At heart of approximate bayesian computing lies the inference of a desired parameter value $\Theta$ for given data $D$ by relating the conditional probability of the data given the parameter value $P(D | \Theta)$ to the symmetric counter part, the conditional probability of the parameter given certain data $P(\Theta | D)$ through Bayes' rule:
