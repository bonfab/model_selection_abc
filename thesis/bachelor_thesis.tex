...
Furthermore, the multivariate Gaussian for a given mean and variance the maximum entropy distribution, for a proof the reader is referred to \cite{cover2012elements}.
