...
Repeated over time this can be formulated mathematically as a stochastic process on the change of allele frequencies, where the total dominance of an allele is an absorbing state. Therefore, after a sufficient amount of time a decrease in genetic diversity will be observed in inbreeding populations as more alleles tend to fixation. The degree of 
